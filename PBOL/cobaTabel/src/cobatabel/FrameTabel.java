...
public class FrameTabel extends javax.swing.JFrame {
     ...
     */
    public FrameTabel(ArrayList<DataPenjualan> data) {
        int i,n;
        
        initComponents();
        
        DefaultTableModel model = (DefaultTableModel) tabelTampilData.getModel();
        
        //Menampilkan ke tabel data dari objek yang dikirimkan dengan ArrayList
        n = data.size();
        for (i = 0; i < n; i++) {
            model.addRow(new Object[]{data.get(i).getTipe(), data.get(i).getWarna(), data.get(i).getSO(), data.get(i).getJum()});
        }
    }
    ...
    private void initComponents() {
        ...
        tabelTampilData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tipe", "Warna", "Sistem Operasi", "Terjual"
            }
        ) {
